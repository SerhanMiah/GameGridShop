    ...
    public partial class MyFirstMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Games",
                columns: new[] { "GameId", "CoverImageUrl", "CreatedDate", "Description", "Developer", "GameGenre", "GamePlatform", "ModifiedDate", "Price", "Publisher", "Rating", "Title", "WebsiteUrl", "YoutubeTrailerId" },
                values: new object[] { 1, "https://example.com/witcher_3_cover.jpg", new DateTime(2023, 9, 6, 14, 31, 19, 915, DateTimeKind.Local).AddTicks(2466), "Embark on a journey as Geralt...", "CD Projekt Red", "RPG", "PC", null, 29.99m, "CD Projekt", "Mature", "The Witcher 3: Wild Hunt", "https://www.playstation.com/en-gb/games/the-witcher-3-wild-hunt/", "c0i88t0Kacs" });

            migrationBuilder.InsertData(
                table: "Rating",
                columns: new[] { "RatingId", "Description", "Name" },
                values: new object[,]
                {
                    { 1, "Everyone", "E" },
                    { 2, "Mature Audience", "Mature" },
                    { 3, "Mature 15+", "Age15Plus" },
                    { 4, "12+", "Age12Plus" }
                });
            ...
            migrationBuilder.InsertData(
                table: "DLC",
                columns: new[] { "DLCId", "Description", "EditionId", "GameId", "Name", "Price", "ReleaseDate" },
                values: new object[,]
                {
                    { 1, "Geralt embarks on a brand-new and expansive 30+ hour adventure in the new region of Toussaint.", null, 1, "Blood and Wine", 19.99m, new DateTime(2016, 5, 31, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, "A new 10-hour single-player story-driven adventure.", null, 1, "Hearts of Stone", 9.99m, new DateTime(2015, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 3, "Explore a forgotten village and discover its terrifying secret.", null, 1, "New Quest - 'Where the Cat and Wolf Play'", 0.00m, new DateTime(2015, 7, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 4, "Enhance your close combat arsenal with a set of new gear.", null, 1, "Skellige Armor Set", 0.00m, new DateTime(2015, 6, 3, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });

            migrationBuilder.InsertData(
                table: "Edition",
                columns: new[] { "EditionId", "GameId", "Name", "Price" },
                values: new object[] { 1, 1, "Standard Edition", 29.99m });
