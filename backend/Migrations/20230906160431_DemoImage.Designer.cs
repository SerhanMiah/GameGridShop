...
namespace backend.Migrations
{
    ...
    [Migration("20230906160431_DemoImage")]
            ...
            modelBuilder.Entity("backend.Model.Game", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 9, 6, 17, 4, 31, 33, DateTimeKind.Local).AddTicks(394),
            ...
            modelBuilder.Entity("backend.Model.GameImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ImageId = 1,
                            GameId = 1,
                            ImageUrl = "https://res.cloudinary.com/danedskby/image/upload/v1694016203/TimelineCovers.pro_video-game-the-witcher-3-wild-hunt-the-score-facebook-cover_sfined.jpg"
                        },
                        new
                        {
                            ImageId = 2,
